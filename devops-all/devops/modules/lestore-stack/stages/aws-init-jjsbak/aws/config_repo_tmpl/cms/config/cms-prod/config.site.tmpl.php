...
$siteConf['cookie_domain'] = 'cms.jjshouse.com';
// }}}
...
$siteConf['proj_name'] = 'jjshouse';
$siteConf['proj_name_upper'] = 'JJsHouse';
$siteConf['proj_domain'] = 'jjshouse.com';
$siteConf['proj_domain_upper'] = 'JJsHouse.com';

// {{{
// product server
$siteConf['server'] = array(
	'www' => 'http://www.jjshouse.com',
	'www_safe' => 'https://www.jjshouse.com',
	'cms' => 'https://cms.jjshouse.com',
	'ticket' => 'http://t.' . $siteConf['proj_domain'],
	'editor' => 'http://editor.jjshouse.com',
	'eseditor' => 'https://eseditor.jjshouse.com',
);
// }}}
...
$siteConf['sys_listen_current_project'] = array('JJsHouse');
...
// 每周要发的主站项目
$siteConf['wMainSiteProjectList'] = array('JJsHouse');
// 每周要发的手机站项目
$siteConf['wMobileSiteProjectList'] = array('JJsHouse');
// 每天要发的主站项目
$siteConf['dMainSiteProjectList'] = array('JJsHouse');
...
/* tax & duty */
$siteConf['sys_all_projects'] = array('JJsHouse');//, 'JenJenHouse', 'JennyJoseph', 'AmorModa', 'DressFirst');
...
$siteConf['send_comment_report_domains'] = array('JJsHouse');
