...
//SendGrid 账户
define('SENDGRID_USERNAME', 'azazie');
...
$siteConf['nl_cdn'] = 'https://newsletter.azazie.com/newsletter/images/';
...
$mailchimp_api_key = '__MAILCHIMP_API_KEY__';
$mailchimp_list_id = '__MAILCHIMP_LIST_ID__';
