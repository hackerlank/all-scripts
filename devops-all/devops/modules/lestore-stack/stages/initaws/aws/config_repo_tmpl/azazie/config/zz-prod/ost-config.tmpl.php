...
define('DBNAME','azazie');
define('DBUSER','jjs0517ticket');
define('DBPASS','azaziecommonpass');

#Table prefix
define('TABLE_PREFIX','ost_');

define('PIC_URL_CDN','http://__CDN_IMG1__/upimg/ticket/');
define('PIC_URL_ORI','http://img.azazie.com/ticket/');
...
###defined('NOTICE_EMAIL') || define('NOTICE_EMAIL', 'customerservice@' . SITE_DOMAIN);
###defined('ALERT_EMAIL') || define('ALERT_EMAIL', 'customerservice@' . SITE_DOMAIN); #changed according to mxu2
###defined('BAK_EMAIL') || define('BAK_EMAIL', 'folder@' . SITE_DOMAIN);
###/*----- end -----*/
###
###define('XHPROF_ROOT','/var/www/xhprof-0.9.2');// xhprof路径
###define('XHPROF_VIEW_URL','http://zt.jjshouse.com/xhprof_html/'); // xhprof查看地址
###$siteConf['cache'] = array(
###    'memcache' => array(
###        'servers' => array(
###            'host' => 'jjscache.sx3zi9.0001.use1.cache.amazonaws.com',
###            'port' => 11211
###        )
###    )
###);
