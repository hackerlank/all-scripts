...
$soap_host = '__TICKET_SOAP_HOST__';
...
# comment the following line if use cloudflare.
...
$siteConf['paypal'] = array(
    ...
    'account_email' => 'paypal@azazie.com',
    'business' => 'zz'
);
...
defined('APP_NAME') || define('APP_NAME', 'Azazie');
 ...
 * authorize.net
 */
defined("AUTHORIZENET_API_LOGIN_ID") || define("AUTHORIZENET_API_LOGIN_ID","__AUTHORIZENET_API_LOGIN_ID__");
defined("AUTHORIZENET_TRANSACTION_KEY") || define("AUTHORIZENET_TRANSACTION_KEY","__AUTHORIZENET_TRANSACTION_KEY__");
defined("AUTHORIZENET_SANDBOX") || define("AUTHORIZENET_SANDBOX",false);
defined("TEST_REQUEST") || define("TEST_REQUEST", false);
defined("AUTHORIZENET_MD5_SETTING") || define("AUTHORIZENET_MD5_SETTING","__AUTHORIZENET_MD5_SETTING__");
