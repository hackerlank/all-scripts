...
define('DBNAME','vbridal');
define('DBUSER','jjs0517ticket');
define('DBPASS','vbridalcommonpass');

#Table prefix
define('TABLE_PREFIX','ost_');

define('PIC_URL_CDN','http://__CDN_IMG1__/upimg/ticket/');
define('PIC_URL_ORI','http://img.vbridal.com/ticket/');
...
###define('XHPROF_VIEW_URL','http://zt.vbridal.com/xhprof_html/'); // xhprof查看地址
