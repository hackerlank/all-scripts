...
#SVN地址信息
#SVN_ADDR='https://svn.pupugao.com/svn/src/web/trunk/jjshouse_romeo'
SVN_ADDR='https://svn.digi800.com/svn/src/web/trunk/jjshouse_romeo'
...
if [ -f /svn/${ENV}/${APPNAME}/out/exploded/romeoWeb/success ];then
            sudo rm -f /svn/${ENV}/${APPNAME}/out/exploded/romeoWeb/success
fi
...
cp /svn/${ENV}/${APPNAME}/flag  /svn/${ENV}/${APPNAME}/out/exploded/romeoWeb/flag

cp /svn/${ENV}/${APPNAME}/version  /svn/${ENV}/${APPNAME}/out/exploded/romeoWeb/version
...
sudo /usr/bin/rsync -qzrtopg --progress --delete -e 'ssh -p38022 -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null' /svn/${ENV}/${APPNAME}/out/exploded/romeoWeb syncer@101.231.200.238:/tmp 
