...
proxyIP="52.4.120.61"
proxyName="America-proxy-0-USA1_${proxyIP}"
...
autossh  -M 40001 ${ssh_ops} -Nnf -L 0.0.0.0:${local_port}:127.0.0.1:${remote_port} ec2-user@${proxyIP} -p38022 -i /root/.ssh/test_rsa
if [ $? = 0 ];then
