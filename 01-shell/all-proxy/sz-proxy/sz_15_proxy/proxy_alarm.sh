...
#backend_servers=(
#        "proxy_backend"
#        "proxy_google_backend"
#        "proxy_shanghai_backend"
#)
backend_servers=(
        "proxy_backend"
        "proxy_shanghai_backend"
...
for backend_server in ${backend_servers[@]}; do
	isExist=$(echo "show stat" | socat stdio $haproxy_socket | grep $backend_server | wc -l)
	...
	isDisabled=$(echo "show stat" | socat stdio $haproxy_socket  | grep $backend_server | grep "MAINT" | wc -l)
